...
public class FeedbackController {
    ...
    List<FeedbackDto> list(@SortDefault(sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable) {
    ...
    List<CommentDto> feedbackComments(@SortDefault(sort = "createdAt", direction = Sort.Direction.ASC)Pageable pageable, @PathVariable("feedbackId") UUID feedbackId) {
